...
public final class PassableFoliageCommonConfig {
    ...
    public static void refresh() {
        ...
        fallDamageThreshold = fallDamageThresholdVal.get();
        ...
        modifyPathFinding = modifyPathFindingVal.get();
        playerOnly = playerOnlyVal.get();
        soundsPlayerOnly = soundsPlayerOnlyVal.get();
